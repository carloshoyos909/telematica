let numeroPagina = 1;
let API_URL = "https://api.themoviedb.org/3/discover/movie?sort_by=popularity.desc&api_key=98927ddba843b80658a25d9d96781942&page=";
const IMG_PATH= "http://image.tmdb.org/t/p/w500/";
let SEARCH_API = "https://api.themoviedb.org/3/search/movie?&api_key=98927ddba843b80658a25d9d96781942&query=";
...
anterior.addEventListener("click",function(){
    if(numeroPagina != 1){
        numeroPagina -= 1;
        if(esBusqueda){
            query = SEARCH_API + busqueda + "&page=" + numeroPagina;
        }
    }
    busquedaONo();
})
